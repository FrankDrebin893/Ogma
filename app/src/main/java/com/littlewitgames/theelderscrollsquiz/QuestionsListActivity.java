...
public class QuestionsListActivity extends ListActivity {
    ...
    public void onClick(View view) {
        ...
        StandardQuestion standardQuestionTest = new StandardQuestion("What is your name?", "Rasmus", "Michael", "John", "George", 1);
        ...
        switch (view.getId()) {
            case R.id.add:
                ...
                standardQuestion = datasource.createStandardQuestion("What is your name?", "Rasmus", "Michael", "John", "George", 1);
